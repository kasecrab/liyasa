...
pub fn registry() -> Registry {
    ...
    Registry(vec![
        ...
        // CM-39: the wrapper that gives a GFM table a caption and wide mode.
        component(
            "table",
            &["Table"],
            Container,
            vec![
                prop("caption", PropType::Str, false),
                prop("sticky", PropType::Bool, false),
                prop("wide", PropType::Bool, false),
            ],
            Vec::new(),
        ),
